...
static bool
parse_ns_prefix(const char *line, uint64_t *out)
{
	char              *end = NULL;
...
bool
stw_parser_try_extract(const char *line, const char *filter, stw_log_frame_t *out)
{
...
bool
_stw_parser_try_extract(const char *line, const char *filter, stw_log_frame_t *out)
{
